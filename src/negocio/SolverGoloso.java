...
public class SolverGoloso implements Solver {
    ...
    private void setCriterio(Criterios criterio) {
        switch (criterio) {
            case PRECIO:
                this.criterio = Criterios.PRECIO;
                break;
            case HORARIO:
                this.criterio = Criterios.HORARIO;
                break;
            case COCIENTE:
                this.criterio = Criterios.COCIENTE;
                break;
            case COMBO:
                this.criterio = Criterios.COMBO;
                break;
            default:
        }
    }
